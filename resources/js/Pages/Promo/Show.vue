                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                            <div class="mt-2 flex items-center text-sm text-gray-300">
                                ...
                                <s>{{ addCommas(product.price_selling) }}</s> &nbsp;&nbsp; {{ addCommas(promo_product.promo_price_selling) }}
                            </div>
                            <div v-if="product.product_stock > 0" class="mt-2 flex items-center text-sm text-gray-300">
                                ...
                                Stok Promo {{ promo_product.promo_product_stock }}
                            </div>
    ...
    data() {
        return {
            form: this.$inertia.form({
                cart_qty: 1,
                promo_id: this.promo_product.promo_id,
                promo_product_id: this.promo_product.promo_product_id,
