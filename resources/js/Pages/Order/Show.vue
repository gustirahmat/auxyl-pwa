                            ...
                            <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                                <dl class="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                                    ...
                                    <div class="sm:col-span-1">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900">
                                            {{ order.related_delivery.delivery_kelurahan }} /
                                            {{ order.related_delivery.delivery_zipcode }}
                                        </dd>
                                    </div>
                                    <div class="sm:col-span-1">
                                        <dt class="text-sm font-medium text-gray-500">
                                    ...
                                    <div class="sm:col-span-2" v-if="!order.order_payment_proof">
                                        ...
                                        <dd class="mt-1 text-sm text-gray-900">
                                            Silahkan melakukan pembayaran via transfer antar bank ke nomor rekening berikut:
                                            ...
                                            <ul class="border border-gray-200 rounded-md divide-y divide-gray-200">
                                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                                                    ...
                                                    <div class="ml-4 flex-shrink-0">
                                                        <a :href="order.order_payment_proof"
                        ...
                        <div class="bg-white shadow sm:rounded-lg sm:overflow-hidden">
                            <div class="divide-y divide-gray-200">
                                ...
                                <div class="px-4 py-6 sm:px-6">
                                    <ul class="space-y-8">
                                        <li>
                                            <div v-for="product in order.related_products"
                                                 :key="product.order_product_id" class="flex space-x-3">
                                                <div class="flex-shrink-0">
                                                    <img class="h-24 sm:h-36 w-24 sm:w-36 object-cover shadow sm:rounded-md sm:overflow-hidden"
                                                         :src="product.related_photos[0].image_url" @error="imgUrlAlt"
                                                         v-bind:alt="product.related_photos[0].image_alt_text"/>
                                                </div>
                                                <div>
                                                    <div class="text-sm">
                                                    ...
                                                    <div class="mt-2 text-sm space-x-2">
                                                        ...
                                                        <span class="text-gray-500 font-medium">{{
                                                                addCommas(product.order_product_price)
                                                            }}</span>
                                                        <span class="text-gray-500 font-medium">&middot;</span>
                                                        <span class="text-gray-900 font-medium">{{
                                                                addCommas(product.order_product_subtotal)
                                                            }}</span>
                                                    </div>
                                                </div>
                                            </div>
